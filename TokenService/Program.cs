...
namespace TokenService
{
    internal class Program
    {
        ...
        {
            string input = @"C:\Users \gia\Desk_top\PassWord.xlsx";
            Console.WriteLine("Input:"+input);
            Console.WriteLine("ResultNumber:"+Utils.CheckInputNumber(input));
            Console.WriteLine("ResultPath:" + Utils.CheckInputPath(input));
        }
    }
}
